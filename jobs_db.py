...
class User(Base):
    ...
    gender = Column(PgEnum(GenderEnum, name='gender', create_type=True), nullable=True)
    ...
    description = Column(String(300), nullable=True)
    workType = Column(PgEnum(WorkTypeEnum, name='work_type', create_type=True), nullable=True)
