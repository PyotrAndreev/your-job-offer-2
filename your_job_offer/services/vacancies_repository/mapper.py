...
from your_job_offer.domain.models.general import (
    Salary,
    Phone,
    Email,
    Date,
...
def mapVacancyDbToVacancyModel(vacancyDb: jobs_db.Vacancy) -> Vacancy:
    return Vacancy(
        job=vacancyDb.job,
        ...
        buisiness_trip_readiness=vacancyDb.businessTripReadiness
        == BusinessTripReadinessEnum.READY,
